...
import { setusersearchTerm, setfiltereduser } from '../../../../redux/reducer';

// function Post() {
// const dispatch=useDispatch();
//   const usersearchTerm = useSelector((state) => state.reducer.usersearchTerm);
//   const filtereduser = useSelector((state) => state.reducer.filtereduser);
...
//     dispatch(setfiltereduser(Alltweets));
...
function Post() {
  ...
  function handleSearchChange(event) {
    ...
    dispatch(setfiltereduser(filtered));
  } // Add the missing closing brace for handleSearchChange function
